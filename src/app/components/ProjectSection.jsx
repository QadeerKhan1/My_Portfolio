...
const ProjectSection = () => {
  ...
  const ProjectsData = [
    ...
    },
    {
      ...
      description:
      "Created an easy-to-use resume builder that helps users make professional resumes. Added templates, customizable sections, and formatting options so users can tailor their resumes for specific jobs.",
      image: darkMode
        ? "/svg/projects/resumeBuilderDark.png"
        : "/svg/projects/resumeBuilderLight.png",
      tag: ["All", "Web"],
      gitUrl: "https://github.com/Ijazahmad45/projectGolf",
      previewUrl: "/",
    },
    {
      ...
      description:
      "Developed an AI-driven system that generates personalized career advice, similar to ChatGPT. Used various AI algorithms to analyze user data and deliver accurate career recommendations.",
      image: darkMode
        ? "/svg/projects/careerCoachDark.png"
        : "/svg/projects/careerCoachLight.png",
      tag: ["All", "Web"],
      gitUrl: "https://github.com/Ijazahmad45/projectGolf",
      previewUrl: "/",
    },
    {
      ...
      "Developed an AI-driven system that generates personalized career advice, similar to ChatGPT. Used various AI algorithms to analyze user data and deliver accurate career recommendations.",
      image: darkMode
        ? "/svg/projects/jobTrackerDark.png"
        : "/svg/projects/jobTrackerLight.png",
      tag: ["All", "Web"],
      gitUrl: "https://github.com/Ijazahmad45/projectGolf",
      previewUrl: "/",
    },
