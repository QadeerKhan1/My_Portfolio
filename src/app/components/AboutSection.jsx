  ...
  const Tab_Data = [
    {
      ...
      content: (
        <ul className={`list-disc pl-2 ${dark}`} >
          ...
          <li>CSS, Bootstrap, SASS, Tailwind</li>
          <li>Material UI, Ant Design, MDB</li>
          <li>React Hooks, RTK Query, Redux Toolkit, API integration</li>
          <li>Npm, Axios</li>
          <li>GitHub, Bitbucket, Agile work flow</li>
        </ul>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <ul className={`pl-2 ${dark}`}>
          <p>
          Highly experienced React and Next.js developer with 1.8 years of expertise, currently advancing innovative solutions at Ninesole Technologies in Islamabad. Specializing in crafting dynamic, user-friendly interfaces with React and Next.js, ensuring optimal performance and seamless functionality. Passionate about delivering top-tier, client-focused solutions that consistently drive success.
          </p>
        </ul>
      ),
    },
